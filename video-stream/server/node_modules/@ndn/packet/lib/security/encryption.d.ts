...
export declare type LLEncrypt = (params: LLEncrypt.Params) => Promise<LLEncrypt.Result>;
...
export declare type LLDecrypt = (params: LLDecrypt.Params) => Promise<LLDecrypt.Result>;
