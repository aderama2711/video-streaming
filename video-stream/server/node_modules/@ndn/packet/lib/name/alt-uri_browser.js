...
class Generic {
    match(comp) { return comp.type === TT.GenericNameComponent; }
    create() { /* istanbul ignore next */ throw new TypeError("not supported"); }
    parse() { /* istanbul ignore next */ throw new TypeError("not supported"); }
